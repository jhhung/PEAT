#ifndef FW_DEVICE_STREAM_HPP_
#define FW_DEVICE_STREAM_HPP_
...
{
private:
	typedef typename Container::pos_type size_type;
	Container& container_;
	size_type pos_;
public:
	
	typedef typename Container::char_type char_type;
	typedef boost::iostreams::seekable_device_tag category;
	bool &is_close_;
	
	StreamDevice(Container& container, bool &ic)
